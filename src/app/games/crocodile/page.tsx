  ...
  async function createRoom(visibility: "private" | "public") {
    ...
    try {
      const response = await fetch("/api/create-room", {
        ...
        body: JSON.stringify({ gameId: "crocodile", visibility })
      });
    ...
    <AppShell>
      <section className="grid flex-1 items-center gap-8 py-12 lg:grid-cols-[0.9fr_1.1fr]">
        <div>
          ...
          <h1 className="mt-3 font-display text-6xl font-semibold text-ink">Крокодил</h1>
          <p className="mt-6 max-w-xl text-lg leading-8 text-slate-600">
            Веселая игра для компании: один игрок объясняет слово без слов, а остальные пытаются его угадать.
            Можно играть каждый сам за себя или командами.
          </p>
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            <a href="/rules/crocodile">
              <Button variant="secondary">Правила игры</Button>
            </a>
          </div>
